...
规则值:
"off"或者0     //关闭检测规则
"warn"或者0    //打开并把打开的检测规则作为警告（不影响退出代码）
"error"或者0   //打开并把检测规则作为一个错误（退出代码触发时为0）
 */
...
module.exports = {
  ...
  rules: {
    ...
    "no-multiple-empty-lines": [0, { max: 0 }], // 空行最多不能超过0行
    ...
    "no-unneeded-ternary": 0, // 禁止不必要的嵌套 var isYes = answer === 0 ? true : false;
